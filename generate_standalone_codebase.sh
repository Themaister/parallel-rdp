...
cp -v Granite/third_party/spirv-cross/spirv_cross.cpp "$OUTDIR/spirv-cross/"
cp -v Granite/third_party/spirv-cross/spirv_cfg.cpp "$OUTDIR/spirv-cross/"
cp -v Granite/third_party/spirv-cross/spirv_parser.cpp "$OUTDIR/spirv-cross/"
cp -v Granite/third_party/spirv-cross/spirv_cross_parsed_ir.cpp "$OUTDIR/spirv-cross/"
cp -v Granite/third_party/spirv-cross/*.hpp "$OUTDIR/spirv-cross/"
cp -v Granite/third_party/spirv-cross/*.h "$OUTDIR/spirv-cross/"
